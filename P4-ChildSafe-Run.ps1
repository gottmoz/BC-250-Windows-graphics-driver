...
"@, [System.Text.RegularExpressions.RegexOptions]::Singleline)
  ...
  $out="C:\Dev\BC250-windowsDriverTest\p4_$ts"
  ...
  $sys=Join-Path $out 'P4_childsafe.sys'
  ...
  Write-Output ("RUN_PROFILE=P4|SYS={0}" -f $sys)
  & 'C:\Dev\BC250-windowsDriverTest\P0-N9C-PnpBind-Hashed-NoReboot.ps1' -ProjectRoot 'C:\Dev\BC250-windowsDriverTest' -N9Dir $out -N9SysName 'P4_childsafe.sys'
}
