    ...
    _In_                             ULONG                  ChildRelationsSize)
{
    ...
    Q2WriteParamDword(L"SampleP_QueryChildRelationsEnter", 1);
    Q2WriteParamDword(L"SampleP_QueryChildRelationsSize", ChildRelationsSize);
    if (pChildRelations == NULL) { Q2WriteParamDword(L"SampleP_QueryChildRelationsStatus", STATUS_INVALID_PARAMETER); Q2MarkCb(101, STATUS_INVALID_PARAMETER); return STATUS_INVALID_PARAMETER; }
    if (ChildRelationsSize < sizeof(DXGK_CHILD_DESCRIPTOR)) { Q2WriteParamDword(L"SampleP_QueryChildRelationsStatus", STATUS_BUFFER_TOO_SMALL); Q2MarkCb(101, STATUS_BUFFER_TOO_SMALL); return STATUS_BUFFER_TOO_SMALL; }
    ...
    pChildRelations[0].ChildCapabilities.Type.VideoOutput.InterfaceTechnology = D3DKMDT_VOT_OTHER;
    ...
    Q2WriteParamDword(L"SampleP_QueryChildRelationsStatus", STATUS_SUCCESS);
    ...
    _In_    BOOLEAN            NonDestructiveOnly)
{
    ...
    if (pChildStatus == NULL) { Q2WriteParamDword(L"SampleP_QueryChildStatusStatus", STATUS_INVALID_PARAMETER); Q2MarkCb(102, STATUS_INVALID_PARAMETER); return STATUS_INVALID_PARAMETER; }
    if (pChildStatus->ChildUid != 0) { Q2WriteParamDword(L"SampleP_QueryChildStatusStatus", STATUS_INVALID_PARAMETER); Q2MarkCb(102, STATUS_INVALID_PARAMETER); return STATUS_INVALID_PARAMETER; }
    ...
    _Inout_ DXGK_DEVICE_DESCRIPTOR* pDeviceDescriptor)
{
    PAGED_CODE();
    UNREFERENCED_PARAMETER(pDeviceContext);
    Q2WriteParamDword(L"SampleP_QueryDeviceDescriptorEnter", 1);
    if (pDeviceDescriptor == NULL || ChildUid != 0) {
        Q2WriteParamDword(L"SampleP_QueryDeviceDescriptorStatus", STATUS_INVALID_PARAMETER);
        Q2MarkCb(103, STATUS_INVALID_PARAMETER);
        return STATUS_INVALID_PARAMETER;
    }
    pDeviceDescriptor->DescriptorLength = 0;
    Q2WriteParamDword(L"SampleP_QueryDeviceDescriptorStatus", STATUS_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED);
...
$out="C:\Dev\BC250-windowsDriverTest\p6_$ts"
...
$sys=Join-Path $out 'P6_child_contract.sys'
...
"RUN_PROFILE=P6|SYS=$sys"
& 'C:\Dev\BC250-windowsDriverTest\P0-N9C-PnpBind-Hashed-NoReboot.ps1' -ProjectRoot 'C:\Dev\BC250-windowsDriverTest' -N9Dir $out -N9SysName 'P6_child_contract.sys'
