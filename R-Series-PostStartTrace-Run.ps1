...
"@
  ...
  $driverEntryRepl = '$0' + "`r`n`r`n    Q2SampleBreadcrumb(pRegistryPath, 1, 2, 0, 0, 15, 0);"
    ...
    _Outptr_ PVOID*  ppDeviceContext)
{
    ...
    {
        Q2MarkCb(10, STATUS_INVALID_PARAMETER);
    ...
    _Out_ ULONG*             NumberOfChildren)
{
    ...
    if (!MiniportDeviceContext || !DxgkStartInfo || !DxgkInterface || !NumberOfVideoPresentSources || !NumberOfChildren) {
        Q2MarkCb(20, STATUS_INVALID_PARAMETER);
        return STATUS_INVALID_PARAMETER;
    }
    ...
    _In_  VOID* pDeviceContext)
{
    ...
    Q2WriteParamDword(L"SampleR_StopEnter", 1);
    Q2MarkCb(30, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nBddDdiStopDevice\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nBddDdiDispatchIoRequest\(', "$stopBody`r`nNTSTATUS`r`nBddDdiDispatchIoRequest(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _In_  VIDEO_REQUEST_PACKET* pVideoRequestPacket)
{
    ...
    Q2WriteParamDword(L"SampleR_DispatchEnter", 1);
    Q2MarkCb(40, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nBddDdiDispatchIoRequest\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nBddDdiSetPowerState\(', "$dispatchBody`r`nNTSTATUS`r`nBddDdiSetPowerState(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _In_  POWER_ACTION       ActionType)
{
    ...
    Q2WriteParamDword(L"SampleR_PowerEnter", 1);
    Q2MarkCb(50, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nBddDdiSetPowerState\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nBddDdiQueryChildRelations\(', "$powerBody`r`nNTSTATUS`r`nBddDdiQueryChildRelations(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _In_                             ULONG                  ChildRelationsSize)
{
    ...
    Q2WriteParamDword(L"SampleR_QueryChildRelationsEnter", 1);
    Q2MarkCb(101, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nBddDdiQueryChildRelations\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nBddDdiQueryChildStatus\(', "$qcrBody`r`nNTSTATUS`r`nBddDdiQueryChildStatus(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _In_    BOOLEAN            NonDestructiveOnly)
{
    ...
    Q2WriteParamDword(L"SampleR_QueryChildStatusEnter", 1);
    Q2MarkCb(102, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nBddDdiQueryChildStatus\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nBddDdiQueryDeviceDescriptor\(', "$qcsBody`r`nNTSTATUS`r`nBddDdiQueryDeviceDescriptor(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _Inout_ DXGK_DEVICE_DESCRIPTOR* pDeviceDescriptor)
{
    ...
    Q2WriteParamDword(L"SampleR_QueryDeviceDescriptorEnter", 1);
    Q2MarkCb(103, STATUS_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED);
    return STATUS_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nBddDdiQueryDeviceDescriptor\([\s\S]*?\r?\n\}\r?\n\r?\n//\r?\n// WDDM Display Only Driver DDIs', "$qddBody`r`n//`r`n// WDDM Display Only Driver DDIs", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _In_ CONST DXGKARG_QUERYADAPTERINFO* pQueryAdapterInfo)
{
    ...
    Q2WriteParamDword(L"SampleR_QueryAdapterInfoEnter", 1);
    Q2MarkCb(104, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nAPIENTRY\r?\nBddDdiQueryAdapterInfo\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nAPIENTRY\r?\nBddDdiSetPointerPosition\(', "$qaiBody`r`nNTSTATUS`r`nAPIENTRY`r`nBddDdiSetPointerPosition(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _Inout_ DXGKARG_ISSUPPORTEDVIDPN* pIsSupportedVidPn)
{
    ...
    Q2WriteParamDword(L"SampleR_IsSupportedVidPnEnter", 1);
    Q2MarkCb(105, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nAPIENTRY\r?\nBddDdiIsSupportedVidPn\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nAPIENTRY\r?\nBddDdiRecommendFunctionalVidPn\(', "$isvBody`r`nNTSTATUS`r`nAPIENTRY`r`nBddDdiRecommendFunctionalVidPn(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _In_ CONST DXGKARG_RECOMMENDFUNCTIONALVIDPN* CONST pRecommendFunctionalVidPn)
{
    ...
    Q2WriteParamDword(L"SampleR_RecommendFunctionalVidPnEnter", 1);
    Q2MarkCb(106, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nAPIENTRY\r?\nBddDdiRecommendFunctionalVidPn\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nAPIENTRY\r?\nBddDdiRecommendVidPnTopology\(', "$rfvBody`r`nNTSTATUS`r`nAPIENTRY`r`nBddDdiRecommendVidPnTopology(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
    ...
    _In_ CONST DXGKARG_ENUMVIDPNCOFUNCMODALITY* CONST pEnumCofuncModality)
{
    ...
    Q2WriteParamDword(L"SampleR_EnumVidPnCofuncModalityEnter", 1);
    Q2MarkCb(107, STATUS_SUCCESS);
    return STATUS_SUCCESS;
}
"@
  $raw = [Regex]::Replace($raw, 'NTSTATUS\r?\nAPIENTRY\r?\nBddDdiEnumVidPnCofuncModality\([\s\S]*?\r?\n\}\r?\n\r?\nNTSTATUS\r?\nAPIENTRY\r?\nBddDdiSetVidPnSourceVisibility\(', "$evcBody`r`nNTSTATUS`r`nAPIENTRY`r`nBddDdiSetVidPnSourceVisibility(", [System.Text.RegularExpressions.RegexOptions]::Singleline)
  ...
  $out="C:\Dev\BC250-windowsDriverTest\r_${Name}_$ts"
  ...
  & 'C:\Dev\BC250-windowsDriverTest\P0-N9C-PnpBind-Hashed-NoReboot.ps1' -ProjectRoot 'C:\Dev\BC250-windowsDriverTest' -N9Dir $out -N9SysName ("R_${Name}.sys")
}

Build-And-RunProfile -Name 'trace1'
