...
"@, [System.Text.RegularExpressions.RegexOptions]::Singleline)
  ...
  $out="C:\Dev\BC250-windowsDriverTest\p7b_$ts"
  ...
  $sys=Join-Path $out 'P7B_descriptor_only.sys'
  ...
  Write-Output ("RUN_PROFILE=P7B|SYS={0}" -f $sys)
  & 'C:\Dev\BC250-windowsDriverTest\P0-N9C-PnpBind-Hashed-NoReboot.ps1' -ProjectRoot 'C:\Dev\BC250-windowsDriverTest' -N9Dir $out -N9SysName 'P7B_descriptor_only.sys'
}
