...
Build-And-RunProfile -Name 'FULL28' -Block $full -CbCount 28
Build-And-RunProfile -Name 'MID14' -Block $mid14 -CbCount 14
Build-And-RunProfile -Name 'MIN8' -Block $min8 -CbCount 8
